...
This research builds upon prior work by integrating these themes—governance, bias, and democratic deliberation—into a unified analysis. Whereas most studies treat bias detection and governance as separate problems, our approach links them empirically. By combining machine learning–based bias detection with sentiment and toxicity analysis of Talk pages, this work investigates whether inclusive, democratic participation correlates with greater neutrality in Wikipedia’s content. This integrated perspective helps fill a key gap between computational text analysis and sociotechnical studies of online governance.
